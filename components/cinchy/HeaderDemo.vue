            ...
            <div class="header-right">
              <div class="inner">
                ...
                <div class="header-login">
                  <a
                    href="https://openwealthfi.s3.amazonaws.com/demo/Final+UBS+(Canada)+Global+Merger+Arbitrage+Fund.pdf"
                    target="_blank"
                ...
                <!-- <div class="header-login">
                                    <n-link to="/subscriptions/1" class="">  &nbsp;<i class="far fa-redo-alt"></i></n-link>
                                </div>   -->
